    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-gradient-to-b from-gray-900 to-gray-800 text-white transition-all duration-300 flex flex-col`}>
        ...
        <div className="p-4 flex items-center gap-3 border-b border-gray-700">
          ...
          {sidebarOpen && (
            <div>
              <h1 className="font-bold text-lg">MigraFácil</h1>
              <p className="text-xs text-red-400">Panel Admin</p>
            </div>
          )}
        </div>
        ...
        <button
          ...
          className="p-4 border-t border-gray-700 flex items-center justify-center text-gray-400 hover:text-white transition-colors"
        >
