...
class CrearAsesorSerializer(serializers.ModelSerializer):
    """Serializer para crear asesores desde admin."""
    password = serializers.CharField(
        write_only=True,
        required=True,
        validators=[validate_password],
    ...
    limite_solicitudes_diarias = serializers.IntegerField(default=10)
